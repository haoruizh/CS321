...
namespace CS321
{
    ...
    public class ExpressionTree
    {
        ...
        /// <returns>bool value present if the c is a valid operator.</returns>
        ...
        private Queue<string> ToPostFix(string infix)
        {
            ...
            for (i = 0; i < infix.Length; ++i)
            {
                ...
                // an operator is encounter
                else
                {
                    // enqueue the current part and make it empty
                    result.Enqueue(currentPart);
                    currentPart = string.Empty;
        ...
        private BaseNode ConstructTree(string expression)
        {
            ...
            // construct the tree
            this.TreeConstruct(treeStack, postfixQueue);
