...
namespace SpreadSheet_LogicEngine
{
    ...
    public class SpreadSheetTest
    {
        ...
        /// <summary>
        /// Test evalulate functionatily in spreadsheet.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Test undo and redo command functionality in spreadsheet.
        /// </summary>
        //[Test]
        //public void UndoRedoTest()
        //{
        //    DataGridView testDataGridView = new DataGridView();
        //    Spreadsheet undoRedoTest = new Spreadsheet(10, 10);
        //    undoRedoTest.Get_Cell(0, 0).Text = "20";
        //    undoRedoTest.Get_Cell(0, 0).Text = "100";
        //    undoRedoTest.UndoExecute(testDataGridView);
        //    Assert.AreEqual("20", undoRedoTest.Get_Cell(0, 0).Value);
        //    undoRedoTest.RedoExecute(testDataGridView);
        //    Assert.AreEqual("100", undoRedoTest.Get_Cell(0, 0).Value);
        //    undoRedoTest.UndoExecute(testDataGridView);
        //    Assert.AreEqual("20", undoRedoTest.Get_Cell(0, 0).Value);
        //}
    }
